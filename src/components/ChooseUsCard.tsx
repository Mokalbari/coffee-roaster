...
const ChooseUsCard = ({ imgSrc, title, textContent, variants }: Props) => {
  return (
    <motion.li
      variants={variants}
      className="mx-auto flex max-w-4/5 flex-col items-center rounded-xl bg-accent-primary px-8 py-16 text-center sm:py-8 sm:max-lg:flex-row sm:max-lg:gap-16 sm:max-lg:text-left lg:max-w-sm lg:p-16"
    >
