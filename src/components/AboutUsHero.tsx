...
const AboutUsHero = () => {
  return (
    <Container>
      <section className="bg-aboutUs-img-mobile sm:bg-aboutUs-img-tablet lg:bg-aboutUs-img-desktop mb-32 rounded-xl bg-cover bg-center bg-no-repeat pb-20 pt-28 leading-8 sm:mb-36 sm:py-28 lg:mb-40 lg:py-36">
